            ...
            <div class="row justify-content-between">
                ...
                <div class="col-auto my-auto">
                    <button type="button" class="btn btn-success rounded-pill" data-bs-toggle="modal"
                        data-bs-target="#addKelas"><i class="fas fa-plus"></i> Tambah <?= $hal ?></button>

                    <div id="addKelas" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        aria-hidden="true" style="display: none;">
                        <div class="modal-dialog">
                            <form action="<?= $base_url_admin ?>/addKelas" method="POST" data-parsley-validate=""
                                class="modal-content">
                                    ...
                                    <div class="col-md-12 my-1">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="nama_kelas"
                                                name="___in_nama_kelas" placeholder="Lorem ipsum dolor sit amet"
                                                required="">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" class="btn btn-xs btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#editKelas<?= $resultData['id_kelas'] ?>"><i
                                                    class="fas fa-edit"></i> Ubah Data</button>
                                        </div>

                                        <div id="editKelas<?= $resultData['id_kelas'] ?>" class="modal fade"
                                            tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                            aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog modal-lg">
                                                <form action="<?= $base_url_admin ?>/editKelas" method="POST"
                                                    ...
                                                    <div class="modal-body row">
                                                        ...
                                                        <div class="col-md-12 my-1">
                                                            <div class="form-floating">
                                                                <input type="text" class="form-control" id="nama_kelas"
                                                                    name="___in_nama_kelas"
                                                                    placeholder="Lorem ipsum dolor sit amet"
                                                                    value="<?= $resultData['nama_kelas'] ?>"
                                                                    required="">
                                                                <label for="nama_kelas">Nama Kelas</label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <input type="hidden" name="___in_id_kelas"
                                                            value="<?= $resultData['id_kelas'] ?>" required="">
                                                        <button type="submit" name="_submit_" class="btn btn-info"><i
                                                                class="fas fa-save"></i> SIMPAN PERUBAHAN</button>
                                                    </div>
                                                </form>
