<?php
    ...
    if (empty($_SESSION['_session__'])) {
        ...
        die();
        exit();
    }elseif((isset($_POST['_submit_'])) OR ($_GET['act']==="aktifkan-pegawai") OR ($_GET['act']==="non-aktifkan-pegawai") OR ($_GET['act']==="reset-session")){
        ...
        switch ($_GET['act']) {
            case "add-pegawai":
                ...
                $level      = htmlspecialchars($_POST['___in_level']);
            ...
            case "aktifkan-pegawai":
                ...
                // Data file
                    $link       = $base_url_admin."/pegawai/".$id_akun;
                    $database   = "akun";
                // Data file
